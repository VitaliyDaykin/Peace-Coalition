(() => {
    ...
    function initSliders() {
        if (document.querySelector(".main__slider")) {
            ...
            document.querySelectorAll(".main__slider").forEach((el => {
        ...
        if (document.querySelector(".team-about__slider")) new core(".team-about__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
        ...
        if (document.querySelector(".slider-ukraine__slider")) new core(".slider-ukraine__slider", {
